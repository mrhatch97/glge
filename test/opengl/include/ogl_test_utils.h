...
#include "test_utils.h"
	...
	// Taken from https://devblogs.nvidia.com/egl-eye-opengl-visualization-without-x-server/
	...
	glge::util::UniqueHandle create_ogl_context()
	{
		...
		return glge::util::UniqueHandle(
			[&]
			{
				...
				{
					throw std::runtime_error("Could not start EGL display connection");
				}
